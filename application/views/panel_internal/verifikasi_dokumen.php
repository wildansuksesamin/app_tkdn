...
<body <?php echo $body_parameter; ?>>
    ...
    <script>
        ...
        function load_data() {
            ...
            data['filter'] = filter;
            data['for'] = 'verifikasi_panel_internal';
                    ...
                    if (list_data.length > 0) {
                        for (var i = 0; i < list_data.length; i++) {
                            ...
                            rangkai += '<tr>' +
                                ...
                                '</td>' +
                                '<td>' +
                                '<a href="' + base_url + 'page/verifikasi_dokumen_panel_internal/' + list_data[i].id_opening_meeting + '" class="btn btn-sm btn-light-primary"><i class="fa fa-folder"></i> Buka Folder</a>' +
                                '</td>' +
                                '</tr>';
                        }
                    }
