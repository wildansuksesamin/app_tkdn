...
<body <?php echo $body_parameter; ?>>
    ...
    <script>
        ...
        function load_data() {
            ...
            data['filter'] = filter;
            data['for'] = 'upload_dokumen_panel_dokumen';
                    ...
                    if (list_data.length > 0) {
                        for (var i = 0; i < list_data.length; i++) {
                            ...
                            rangkai += '<tr>' +
                                ...
                                '</td>' +
                                '<td>' +
                                render_badge(list_data[i].status[0], list_data[i].status[1]) +
                                '</td>' +
                                '<td>' +
                                '<a href="' + base_url + 'page/upload_dokumen_panel_internal/' + list_data[i].id_opening_meeting + '" class="btn btn-sm btn-light-primary"><i class="fa fa-upload"></i> Upload File</a>' +
                                '</td>' +
                                '</tr>';
                        }
                    }
