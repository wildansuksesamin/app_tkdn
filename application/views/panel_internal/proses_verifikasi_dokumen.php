                        ...
                        <div id="kt_app_content" class="app-content flex-column-fluid">
                            <div id="kt_app_content_container" class="app-container container-fluid">
                                ...
                                <div class="card card-flush h-lg-100 tabel_zone" id="tabel_dokumen_penawaran">
                                    ...
                                    <div class="card-header pt-7">
                                        ...
                                        <div>
                                            <div class="fw-bold fs-3">
                                                <?php echo ($konten['from'] == 'panel_internal_dokumen' ? $konten['panel_internal_dokumen']->nama_file : $konten['lhv']->lhv_jns_produk); ?>
                                            </div>
                                            <?php echo ($konten['from'] == 'panel_internal_dokumen' ? '<div>' . $konten['panel_internal_dokumen']->value . '</div>' : ''); ?>
                                        </div>
                                        <!--end::Card title-->
                                    </div>
                                    <!--begin::Body-->
                                    <div class="card-body">
                                        <?php
                                        if ($konten['from'] == 'panel_internal_dokumen') {
                                            $filename = $konten['panel_internal_dokumen']->path_file;
                                            ...
                                            echo '<iframe src="' . base_url() . 'panel_internal/dokumen_lhv/' . $konten['lhv']->id_panel_internal_lhv . '" style="width: 100%; border: unset; height: 500px;"></iframe>';
                                        }
    ...
    ?>
        <script>
            ...
            function proses_verifikasi(status_verifikasi, alasan_verifikasi) {
                ...
                data['id'] = '<?php echo ($konten['from'] == 'panel_internal_dokumen' ? $konten['panel_internal_dokumen']->id_panel_internal_dokumen : $konten['lhv']->id_panel_internal_lhv); ?>';
            ...
            function after_verifikasi() {
                location.href = base_url + "page/verifikasi_dokumen_panel_internal/<?php echo $konten['opening_meeting']->id_opening_meeting; ?>";
            }
        </script>
    <?php
    }
