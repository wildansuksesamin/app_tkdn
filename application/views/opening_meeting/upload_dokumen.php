...
<body <?php echo $body_parameter; ?>>
    ...
    <script>
        ...
        function load_data() {
            ...
            data['filter'] = filter;
            data['for'] = 'upload_dokumen_opening_meeting';
                    ...
                    if (list_data.length > 0) {
                        for (var i = 0; i < list_data.length; i++) {
                            ...
                            rangkai += '<tr>' +
                                ...
                                '<a href="' + base_url + 'page/upload_dokumen_opening_meeting/' + list_data[i].id_opening_meeting + '" class="menu-link px-3"><i class="fa fa-plus pe-3"></i> Upload Dokumen</a>' +
                                '</div>' +
