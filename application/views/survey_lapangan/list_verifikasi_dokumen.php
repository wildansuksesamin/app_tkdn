...
<body <?php echo $body_parameter; ?>>
                    ...
                    <div class="d-flex flex-column flex-column-fluid">
                        ...
                        <div id="kt_app_content" class="app-content flex-column-fluid">
                            <div id="kt_app_content_container" class="app-container container-fluid">
                                ...
                                <div class="card card-flush h-lg-100 tabel_zone" id="tabel_survey_lapangan_perjab">
                                    ...
                                    <div class="card-body p-lg-17" style="padding-top: unset!important;">
                                        <!--begin::Layout-->
                                        <div id="data_zona_survey_lapangan_perjab">
                                            <div class="d-flex flex-column flex-lg-row">
                                                <!--begin::Content-->
                                                <div class="flex-lg-row-fluid me-0">
                                                    <div class="table-responsive">
                                                        <table class="table table-sm table-striped gy-5" id="data_survey_lapangan_perjab">
                                                            <thead>
    ...
    <script>
        ...
        function load_data() {
            ...
            data['filter'] = filter;
            data['from'] = 'verifikasi_dokumen';

            ajax_request = $.ajax({
                type: "POST",
                url: '<?php echo base_url(); ?>/survey_lapangan_perjab/load_data',
                ...
                success: function(result) {
                    ...
                    if (list_data.length > 0) {
                        for (var i = 0; i < list_data.length; i++) {
                            rangkai += '<tr>' +
                                ...
                                '</td>' +
                                '<td>' +
                                '<div class="text-gray-800 fw-bold fs-6">Rp ' + rupiah(list_data[i].biaya_operasional) + '</div>' +
                                '</td>' +

                                '<td>' +
                                '<a href="' + base_url + 'page/verifikasi_dokumen_survey_lapangan/' + list_data[i].id_survey_lapangan_perjab + '" class="btn btn-sm btn-primary"><i class="fa fa-check-circle"></i> Verifikasi Dokumen</a>' +
                                '</td>' +
                                '</tr>';
                        }
                    }
                    ...
                    if (rangkai) {
                        $("#empty_state").remove();
                        $("#data_zona_survey_lapangan_perjab").show();

                        $("#data_survey_lapangan_perjab tbody").html(rangkai);
                        KTMenu.createInstances();
                    } else {
                        if (page == 1 && filter == '') {
                            create_empty_state("#data_zona_survey_lapangan_perjab");
                        } else
                            $("#data_survey_lapangan_perjab tbody").html('');
                    }
