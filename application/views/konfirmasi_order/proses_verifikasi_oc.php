                        ...
                        <div id="kt_app_content_container" class="app-container container-fluid">
                            ...
                            <div class="card card-flush h-lg-100 tabel_zone" id="tabel_dokumen_penawaran">
                                ...
                                <div class="card-body">
                                    ...
                                    <iframe src="<?php echo base_url().'surat_oc/dokumen_pdf/'.$konten['surat_oc']->id_surat_oc; ?>" style="width: 100%; border: unset; height: 500px;"></iframe>
                                </div>
                                <!--end::Body-->
                            </div>
                        </div>
...
?>
    <script>
        ...
        function proses_verifikasi_surat_penawaran(status_verifikasi, alasan_verifikasi){
            ...
            $.ajax({
                type: "POST",
                url: '<?php echo base_url(); ?>surat_oc/verifikasi_surat_oc',
        ...
        function after_verifikasi(){
            location.href=base_url+"page/verifikasi_konfirmasi_order";
        }
    </script>
<?php
}
