...
<body <?php echo $body_parameter; ?>>
    ...
    <script>
        ...
        function load_data() {
            ...
            data['filter'] = filter;
            data['from'] = 'buat_proforma_invoice';
                ...
                success: function(result) {
                    ...
                    if (list_data.length > 0) {
                        for (var i = 0; i < list_data.length; i++) {
                            if (list_data[i].status_pengajuan == 18)
                                var button = '<a class="dropdown-item text-hover-primary" href="' + base_url + 'page/form_proforma_invoice/' + list_data[i].id_surat_oc + '"><?php echo getSvgIcon('files/fil025', 'svg-icon svg-icon-3'); ?> Revisi Proforma Invoice</a>';
                            else
                                var button = '<a class="dropdown-item text-hover-primary" href="' + base_url + 'page/form_proforma_invoice/' + list_data[i].id_surat_oc + '"><?php echo getSvgIcon('files/fil025', 'svg-icon svg-icon-3'); ?> Buat Proforma Invoice</a>';
