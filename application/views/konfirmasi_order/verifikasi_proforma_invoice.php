                    ...
                    if (list_data.length > 0) {
                        for (var i = 0; i < list_data.length; i++) {
                            var btn_action = '<div class="dropdown">' +
                                ...
                                '<a class="dropdown-item text-hover-primary" href="' + base_url + 'page/proses_verifikasi_proforma_invoice/' + list_data[i].id_surat_oc + '"><?php echo getSvgIcon('general/gen043', 'svg-icon svg-icon-3'); ?> Verifikasi Proforma Invoice</a>' +
