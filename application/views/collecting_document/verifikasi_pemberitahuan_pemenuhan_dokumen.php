...
<body <?php echo $body_parameter; ?>>
    ...
    <script>
        ...
        function load_data() {
            ...
            ajax_request = $.ajax({
                type: "POST",
                url: '<?php echo base_url(); ?>pemberitahuan_pemenuhan_dokumen/load_data',
                    ...
                    if (list_data.length > 0) {
                        for (var i = 0; i < list_data.length; i++) {
                            ...
                            var btn_action = '<div class="dropdown">' +
                                ...
                                '<a class="dropdown-item text-hover-primary" href="' + base_url + 'page/verifikasi_pemberitahuan_pemenuhan_dokumen/' + list_data[i].id_opening_meeting + '"><?php echo getSvgIcon('arrows/arr064', 'svg-icon svg-icon-3'); ?> Verifikasi Dokumen</a>' +
                                '</div>' +
                                '</div>';
                            rangkai += '<tr>' +
                                ...
                                render_assesor('Verifikator: ' + list_data[i].nama_admin) +
                                '</td>' +
                                '<td>' +
                                '<div class="text-gray-800 fw-bold mb-1 fs-6">' + coverMe(list_data[i].nomor_surat) + '</div>' +
                                '</td>' +
                                '<td>' +
                                display_sisa_hari +
                                '</td>' +
