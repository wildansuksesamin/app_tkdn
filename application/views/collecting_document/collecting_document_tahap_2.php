...
<body <?php echo $body_parameter; ?>>
    ...
    <script>
        ...
        function load_data() {
            ...
            data['filter'] = filter;
            data['for'] = 'collecting_document_tahap_2';
                ...
                success: function(result) {
                    ...
                    if (list_data.length > 0) {
                        for (var i = 0; i < list_data.length; i++) {
                            var sign_right = redDot('danger', 'style="margin-left: 5px;"');

                            if (!list_data[i].collecting_dokumen_tahap2['dokumen_menunggu_verifikasi']) {
                                sign_right = '';
                            }
                            ...
                            rangkai += '<tr>' +
                                ...
                                '</td>' +
                                '<td>' +
                                '<div class="text-gray-800 fw-bold fs-6" style="max-width: 300px; text-overflow:ellipsis;overflow: hidden;white-space: nowrap;">' + list_data[i].nama_badan_usaha + ' ' + list_data[i].nama_perusahaan + '</div>' +
                                'PIC: ' + list_data[i].nama_pejabat_penghubung_proses_tkdn +
                                '</td>' +
                                '<td class="text-gray-800 fw-bold mb-1 fs-6">' +
                                render_badge('success', list_data[i].collecting_dokumen_tahap2['jml_dokumen'] + ' Dokumen') +
                                '</td>' +

                                '<td>' +
                                '<a href="' + base_url + 'page/verifikasi_collecting_document_2/' + list_data[i].id_opening_meeting + '" class="btn btn-light-primary"><i class="fa fa-folder"></i> Buka Folder ' + sign_right + '</a>' +
