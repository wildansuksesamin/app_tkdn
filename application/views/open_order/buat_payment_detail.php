...
<body <?php echo $body_parameter; ?>>
    ...
    <script>
        ...
        function load_data() {
            ...
            data['filter'] = filter;
            data['from'] = 'buat_payment_detail';


            ajax_request = $.ajax({
                type: "POST",
                url: '<?php echo base_url(); ?>/form_01/load_data',
                    ...
                    if (list_data.length > 0) {
                        for (var i = 0; i < list_data.length; i++) {
                            ...
                            rangkai += '<tr>' +
                                ...
                                '<a class="dropdown-item text-hover-primary" href="' + base_url + 'page/buat_payment_detail/' + list_data[i].id_form_01 + '"><i class="fa fa-arrow-circle-right" style="margin-left: 5px;"></i> ' + label_btn + '</a>' +
                                ...
                                button +
                                '<a class="dropdown-item text-hover-primary" href="' + base_url + 'page/lihat_form_01/' + list_data[i].id_surat_oc + '">Form 01</a>' +
                                '</div>' +
                                '</div>' +
                                '</td>' +
                                '</tr>';
