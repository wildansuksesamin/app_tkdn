                        ...
                        <div id="kt_app_content_container" class="app-container container-fluid">
                            ...
                            <div class="card card-flush h-lg-100 tabel_zone" id="tabel_dokumen_penawaran">
                                ...
                                <div class="card-body">
                                    ...
                                    <input type="hidden" id="id_form_01" name="id_form_01" value="<?php echo $konten['surat_oc']->id_form_01; ?>">
                                    ...
                                    <iframe src="<?php echo base_url().'form_01/dokumen_pdf/'.$konten['surat_oc']->id_form_01; ?>" style="width: 100%; border: unset; height: 500px;"></iframe>
                                </div>
                                <!--end::Body-->
                            </div>
                        </div>
...
?>
    <script>
        $("#setuju").click(function(){
            var pertanyaan = "Apakah Anda yakin menyetujui form 01 ini?";

            konfirmasi(pertanyaan, function(){
                $("#setuju").attr({"data-kt-indicator": "on", 'disabled': true});
                proses_verifikasi_form_01('setuju');
            });

        });
        $("#tolak").click(function(){
            var pertanyaan = "Apakah Anda yakin menolak form 01 ini? Jika Anda menolak, admin akan merevisi form 01 ini.";
            ...
            swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    proses_verifikasi_form_01('ditolak', result.value);
                }

            });
        });

        function proses_verifikasi_form_01(status_verifikasi, alasan_verifikasi){
            ...
            $.ajax({
                type: "POST",
                url: '<?php echo base_url(); ?>form_01/verifikasi_form_01',
        ...
        function after_verifikasi(){
            location.href=base_url+"page/verifikasi_form_01";
        }
    </script>
<?php
}
