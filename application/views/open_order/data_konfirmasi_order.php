                    ...
                    if (list_data.length > 0) {
                        for (var i = 0; i < list_data.length; i++) {
                            ...
                            if (list_data[i].termin_1 > 0) {
                                button_bukti_bayar = '<a class="dropdown-item" href="javascript:;" onclick="lihat_bukti_bayar(' + i + ')">Lihat Bukti Bayar</a>';
                            }

                            var style_button = 'primary';
                            var label_button = 'Buat Form 01';
                            if (list_data[i].status_pengajuan == 22) {
                                style_button = 'warning';
                                label_button = 'Revisi Form 01';
                            }
                            rangkai += '<tr>' +
                                ...
                                '</td>' +
                                '<td>' +
                                '<a href="' + base_url + 'page/buat_form_01/' + list_data[i].id_surat_oc + '" class="btn btn-light-' + style_button + ' btn-sm">' + label_button + ' <i class="fa fa-arrow-circle-right" style="margin-left: 5px;"></i></a>' +
                                '</td>' +
                                '</tr>';
                        }
                    }
