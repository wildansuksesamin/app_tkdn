                            ...
                            <div id="kt_app_content_container" class="app-container container-fluid">
                                ...
                                <div class="card card-flush h-lg-100 tabel_zone" id="tabel_dokumen_penawaran">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <?php
                                        $file = $konten['opening_meeting']->surat_perpanjangan_waktu;
                                        $extension = pathinfo($file, PATHINFO_EXTENSION);

                                        if ($extension == 'pdf') {
                                            echo '<iframe src="' . base_url() . $file . '" style="width: 100%; border: unset; height: 500px;"></iframe>';
                                        } else {
                                            echo '<img src="' . base_url() . $file . '" style="max-width: 100%; height: auto">';
                                        }
                                        ?>
                                    </div>
                                    <!--end::Body-->
