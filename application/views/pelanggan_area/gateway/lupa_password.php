                    ...
                    <div class="w-md-400px">
                        ...
                        <form class="form w-100" novalidate="novalidate" id="kt_sign_in_form" action="#">
                            ...
                            <div class="text-center mb-11">
                                ...
                                <!--begin::Title-->
                                <h1 class="text-dark fw-bolder mb-3">Kesulitan Login?</h1>
                                <!--end::Title-->
                                <!--begin::Subtitle-->
                                <div class="text-gray-500 fw-semibold fs-6">Masukkan email yang terdaftar dan kami akan mengirimi Anda tautan untuk kembali ke akun Anda.</div>
                                <!--end::Subtitle=-->
                            </div>
                            <!--begin::Heading-->
                            ...
                            <div class="d-grid mb-10">
                                <button type="button" id="reset_password" class="btn btn-primary">
                                    <!--begin::Indicator label-->
                                    <span class="indicator-label">Kirim Tautan Masuk</span>
                                    <!--end::Indicator label-->
    ...
    <script>
        ...
        function reset_password() {
            ...
            if (email == '') {
                ...
                $.ajax({
                    type: "POST",
                    url: '<?php echo base_url(); ?>request_forgot_password/proses',
                    data: 'data_send=' + encodeURIComponent(JSON.stringify(data)),
                    cache: false,
                    dataType: "json",
                    success: function(data) {
                        //hide loading animation...
                        $("#reset_password").removeAttr('disabled data-kt-indicator');

                        if (data.sts == 1) {
                            location.href = '<?php echo base_url(); ?>pelanggan/lupa_password/berhasil?email=' + data.email;
