                    ...
                    <div class="w-md-400px">
                        ...
                        <form class="form w-100" novalidate="novalidate" id="kt_sign_in_form" action="#">
                            ...
                            <div class="text-center mb-11">
                                ...
                                <!--begin::Title-->
                                <h1 class="text-dark fw-bolder mb-3">Daftar Berhasil</h1>
                                <!--end::Title-->
                                <!--begin::Subtitle-->
                                <div class="text-gray-500 fw-semibold fs-6">Proses pendaftaran Anda telah berhasil dilakukan. Kami telah mengirimkan pesan ke <b><?php echo $konten['email']; ?></b>. Anda untuk memverifikasi alamat email Anda. Silahkan cek email Anda.</div>
                                <!--end::Subtitle=-->
                            </div>
                            <!--begin::Heading-->
                            <!--begin::Submit button-->
