                    ...
                    <div class="w-md-400px">
                        ...
                        <form class="form w-100" novalidate="novalidate" id="kt_sign_in_form" action="#">
                            ...
                            <div class="text-center mb-11">
                                ...
                                <!--begin::Title-->
                                <h1 class="text-dark fw-bolder mb-3">Tautan Tidak Valid</h1>
                                <!--end::Title-->
                                <!--begin::Subtitle-->
                                <div class="text-gray-500 fw-semibold fs-6">Tautan yang Anda ikuti mungkin rusak atau kadaluarsa. Anda dapat melakukan verifikasi email.</div>
                                <!--end::Subtitle=-->
                            </div>
                            <!--begin::Heading-->
                            <!--begin::Submit button-->
                            <div class="d-grid mb-10">
                                <a href="<?php echo base_url().'pelanggan/request_verifikasi_email'; ?>" class="btn btn-primary">Request Verifikasi Email</a>
                            </div>
                            <!--end::Submit button-->
                        </form>
                        <!--end::Form-->
