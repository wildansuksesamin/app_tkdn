...
<body <?php echo $body_parameter; ?>>
    ...
    <script>
        ...
        function load_data() {
            ...
            data['filter'] = filter;
            data['from'] = 'riwayat_payment_detail';
                ...
                success: function(result) {
                    ...
                    if (list_data.length > 0) {
                        for (var i = 0; i < list_data.length; i++) {
                            rangkai += '<tr>' +
                                ...
                                '<td><div class="text-gray-800 fw-bold mb-1 fs-6">' + reformatDate(list_data[i].tgl_payment_detail, 'DD MMMM YYYY') + '</div></td>' +
                                '<td>' +
                                '<div class="text-gray-800 fw-bold mb-1 fs-6">' + coverMe(list_data[i].nomor_order_payment) + '</div>' +
                                '<div class="text-gray-400 fw-semibold d-block fs-7">' + list_data[i].nama_badan_usaha + ' ' + list_data[i].nama_perusahaan + '</div>' +
                                '</td>' +
                                '<td><div class="text-gray-800 fw-bold mb-1 fs-6">' + coverMe(list_data[i].bidang_operasi) + '</div></td>' +
                                '<td>' +
                                '<a href="' + base_url + 'page/lihat_payment_detail/' + list_data[i].id_payment_detail + '" class="btn btn-light-primary btn-sm">Lihat Dokumen <i class="fa fa-arrow-circle-right" style="margin-left: 5px;"></i></a>' +
                                '</td>' +
                                '</tr>';
                        }
                    }
                    ...
                    if (rangkai) {
                        ...
                        if (page == 1 && filter == '') {
                            ...
                            $("#data_payment_detail tbody").html('');
                    }
