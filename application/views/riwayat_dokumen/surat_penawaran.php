                ...
                success: function(result) {
                    ...
                    if (list_data.length > 0) {
                        for (var i = 0; i < list_data.length; i++) {
                            var button = '<a href="' + base_url + 'page/lihat_surat_penawaran/' + list_data[i].id_rab + '" class="btn btn-light-primary btn-sm">Lihat Dokumen <i class="fa fa-arrow-circle-right" style="margin-left: 5px;"></i></a>';
                            rangkai += '<tr>' +
                                '<td>' + (((page - 1) * jml_data) + i + 1) + '.</td>' +
                                '<td><div class="text-gray-800 fw-bold mb-1 fs-6">' + reformatDate(list_data[i].tgl_surat_penawaran) + '</div></td>' +
                                '<td>' +
                                ...
                                '<div class="text-gray-400 fw-semibold d-block fs-7" style="max-width: 200px; text-overflow:ellipsis;overflow: hidden;white-space: nowrap;">' + list_data[i].rincian_produk_pekerjaan + '</div>' +
                                '</td>' +
                                '<td>' +
