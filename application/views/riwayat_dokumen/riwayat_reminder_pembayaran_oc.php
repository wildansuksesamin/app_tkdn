...
<body <?php echo $body_parameter; ?>>
    ...
    <script>
        ...
        function load_data() {
            ...
            ajax_request = $.ajax({
                type: "POST",
                url: '<?php echo base_url(); ?>Pesan/load_data',
                    ...
                    if (list_data.length > 0) {
                        for (var i = 0; i < list_data.length; i++) {
                            rangkai += '<tr>' +
                                ...
                                '<td>' + coverMe(list_data[i].nomor_oc) + '</td>' +
                                '<td>' +
                                '<a href="' + base_url + 'page/lihat_reminder_pembayaran_oc/' + list_data[i].id_pesan + '" class="btn btn-light-primary btn-icon-primary btn-sm">Lihat Dokumen <?php echo getSvgIcon('arrows/arr064', 'svg-icon svg-icon-1'); ?></a>' +
                                '</td>' +
                                '</tr>';
                        }
                    }
