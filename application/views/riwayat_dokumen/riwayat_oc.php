                ...
                success: function(result) {
                    ...
                    if (list_data.length > 0) {
                        for (var i = 0; i < list_data.length; i++) {
                            ...
                            if (list_data[i].bukti_bayar) {
                                button_bukti_bayar = '<a class="dropdown-item" href="javascript:;">Bukti Pembayaran</a>';
                            }
                            var surat_oc_pelanggan = '';
                            if (list_data[i].surat_oc_pelanggan) {
                                surat_oc_pelanggan = '<a class="dropdown-item" href="' + base_url + 'page/lihat_oc_pelanggan/' + list_data[i].id_surat_oc + '">Konfirmasi Order Pelanggan</a>';
                            }
                            var waktu_pelaksanaan = '-';
                            if (list_data[i].tgl_mulai_pelaksanaan && list_data[i].tgl_akhir_pelaksanaan) {
                                waktu_pelaksanaan = '<div class="text-gray-400 fw-semibold d-block fs-7">Tanggal Mulai</div>' +
                            ...
                            rangkai += '<tr>' +
                                ...
                                '<a class="dropdown-item" href="' + base_url + 'page/lihat_oc/' + list_data[i].id_surat_oc + '">Konfirmasi Order</a>' +
                                button_bukti_bayar +
                                surat_oc_pelanggan +
                                '</div>' +
                                '</div>' +
