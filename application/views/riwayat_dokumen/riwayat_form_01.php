                    ...
                    if (list_data.length > 0) {
                        for (var i = 0; i < list_data.length; i++) {
                            rangkai += '<tr>' +
                                ...
                                '</td>' +
                                '<td>' +
                                '<a href="' + base_url + 'page/lihat_form_01/' + list_data[i].id_surat_oc + '" class="btn btn-light-primary btn-sm">Lihat Dokumen <i class="fa fa-arrow-circle-right" style="margin-left: 5px;"></i></a>' +
                                '</td>' +
                                '</tr>';
                        }
                    }
