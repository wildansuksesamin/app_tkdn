...
<body <?php echo $body_parameter; ?>>
    ...
    <script>
        function form_action(action) {
            //reset form...
            $("#input_form_dokumen_penawaran")[0].reset();
            $("#action").val('save');
                    ...
                    if (list_data.length > 0) {
                        for (var i = 0; i < list_data.length; i++) {
                            rangkai += '<tr>' +
                                ...
                                '<td>' + reformatDate(list_data[i].tgl_penyusunan_rab, 'DD MMMM YYYY') + '</td>' +
                                '<td>' +
                                ...
                                '</td>' +
                                '<td><div>' + coverMe(list_data[i].nama_produk_jasa) + '</div>' + render_badge_tipe_pengajuan(list_data[i].tipe_pengajuan) + '</td>' +
                                '<td>Rp ' + rupiah(list_data[i].nilai_kontrak) + '</td>' +
                                '<td><a href="' + base_url + 'page/proses_approval_rab/' + list_data[i].id_rab + '" class="btn btn-icon-primary btn-text-primary" style="padding: unset; background: unset"><?php echo getSvgIcon('general/gen043', 'svg-icon svg-icon-2'); ?> Verifikasi RAB</a></td>' +
                                '</tr>';
                        }
                    }
