...
<body <?php echo $body_parameter; ?>>
    ...
    <?php $this->view('dokumen_permohonan/modal_assesor'); ?>
    ...
    <script>
        ...
        function batalkan_permohonan(id_dokumen_permohonan, nama_perusahaan) {
            var pertanyaan = "Apakah Anda yakin ingin membatalkan permohonan dari perusahaan <strong>" + nama_perusahaan + "</strong>?";
            ...
            swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    proses_batalkan_permohonan(id_dokumen_permohonan, result.value);
                }

            });
        }

        function proses_batalkan_permohonan(id_dokumen_permohonan, alasan) {
                ...
                success: function(result) {
                    ...
                    if (list_data.length > 0) {
                        for (var i = 0; i < list_data.length; i++) {
                            var status_pengajuan = status_pengajuan_badge(list_data[i].status_pengajuan);
                            ...
                            var btn_action = '<div class="dropdown">' +
                                ...
                                '<a class="dropdown-item" href="' + base_url + 'page/detail_dokumen_permohonan/' + list_data[i].id_dokumen_permohonan + '">Lihat Detail</a>' +
                                '<a class="dropdown-item" href="#" onclick="tambah_assesor(' + list_data[i].id_dokumen_permohonan + ', \'' + list_data[i].nama_badan_usaha + ' ' + list_data[i].nama_perusahaan + '\')">Verifikator</a>' +
                                (list_data[i].status_pengajuan == 3 ? '<a class="dropdown-item text-danger fw-semibold" href="#" onclick="batalkan_permohonan(' + list_data[i].id_dokumen_permohonan + ', \'' + list_data[i].nama_badan_usaha + ' ' + list_data[i].nama_perusahaan + '\')">Batalkan Permohonan</a>' : '') +
                                '</div>' +
                                '</div>';
                            ...
                            rangkai += '<tr>' +
                                ...
                                '<td>' +
                                '<div class="text-gray-400 fw-semibold d-block mt-2 fs-7">' + reformatDate(list_data[i].tgl_pengajuan, 'DD MMMM YYYY') + '</div>' +
                                ...
                                (list_data[i].assesor ? render_assesor('Verifikator: ' + list_data[i].assesor.nama_admin) : render_badge('light-danger', 'Belum Ada Verifikator')) +
                                '</td>' +
